		...
		<header className={styles.header}>
			...
			{isDesktop && (
				<div className={styles.desktopStats}>
					<div className={styles.desktopProgressTrack}>
						<div
							className={styles.desktopProgressFill}
							style={{ width: `${progressPercentage}%` }}
						/>
					</div>
					<span className={styles.desktopStatValue}>
						{progress.completed}/{progress.total}
					</span>
					<span className={styles.desktopStatValue}>
						L{getLessonNumber(activeLesson)}
					</span>
					<span className={styles.desktopStatValue}>🔥 {currentStreak}</span>
				</div>
			)}
			...
			{!isDesktop && (
				<div className={styles.headerRight}>
					...
					>
						...
						<span
							className={`${styles.statsPillChevron} ${statsDrawerOpen ? styles.chevronOpen : ""}`}
						>
							▼
						</span>
					</button>
